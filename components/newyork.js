...
const apiurl = 'https://api.openweathermap.org/data/2.5/weather?id=5128581&units=metric&appid=edd3b79527fbe606b38fd4757220f789'

const forecasturl = 'https://api.openweathermap.org/data/2.5/forecast?id=5128581&units=metric&appid=edd3b79527fbe606b38fd4757220f789'
...
export class Newyork extends Component {
  ...
  handleSubmit(e){
	...
	if (!this.state.forecastData) return <p>Loading...</p>
		...
		return (
			<div>
				<h1> New York Deatiled Weather </h1>
